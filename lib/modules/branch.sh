...
'
  ...
  GF_BRANCH_HEADER_BRANCH_CHECKOUT="    ${GREEN}${BOLD}checkout ${YELLOW}${BOLD}${NORMAL}  ${WHITE}${GIT_FUZZY_BRANCH_CHECKOUT_KEY}${NORMAL}"
  GF_BRANCH_HEADER_FILE_CHECKOUT="    ${GREEN}${BOLD}checkout ${YELLOW}${BOLD}📁${NORMAL} ${WHITE}${GIT_FUZZY_BRANCH_CHECKOUT_FILE_KEY}${NORMAL}"
  ...
  if [ -n "$(git status --short)" ]; then
    ...
    GF_BRANCH_HEADER_BRANCH_CHECKOUT="${GRAY}(${RED}${BOLD}*${GRAY}) ${RED}${BOLD}checkout ${YELLOW}${BOLD}${NORMAL}  ${WHITE}${GIT_FUZZY_BRANCH_CHECKOUT_KEY}${NORMAL}"
    GF_BRANCH_HEADER_FILE_CHECKOUT="${GRAY}(${RED}${BOLD}*${GRAY}) ${RED}${BOLD}checkout ${YELLOW}${BOLD}📁${NORMAL} ${WHITE}${GIT_FUZZY_BRANCH_CHECKOUT_FILE_KEY}${NORMAL}"
...
GF_BRANCH_HEADER="$GF_BRANCH_HEADER"'
  '"${YELLOW}${BOLD}∆${NORMAL} ${GREEN}working copy${NORMAL}  ${WHITE}$GIT_FUZZY_BRANCH_WORKING_COPY_KEY${NORMAL}    $GF_BRANCH_HEADER_BRANCH_CHECKOUT"'
    '"${YELLOW}${BOLD}∆${NORMAL} ${GREEN}merge-base${NORMAL}  ${WHITE}$GIT_FUZZY_BRANCH_MERGE_BASE_KEY${NORMAL}     $GF_BRANCH_HEADER_FILE_CHECKOUT"'
      '"${GREEN}commit log${NORMAL}  ${WHITE}$GIT_FUZZY_BRANCH_COMMIT_LOG_KEY${NORMAL}     $GF_BRANCH_HEADER_PATCH_CHECKOUT"'
      '"                     ${RED}${BOLD}delete branch ✗${NORMAL}  ${WHITE}$GIT_FUZZY_BRANCH_DELETE_BRANCH_KEY${NORMAL}"'
